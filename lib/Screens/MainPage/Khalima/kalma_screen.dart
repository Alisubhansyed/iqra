                      ...
                      return InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => KalmaView(
                                    arbicKalma: kalma_arabic[index],
                                    urduKalma: kalma_urdu[index],
                                  )));
                        },
                        child: Card(
                          elevation: 5,
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: const BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(
                                                  "assets/images/kbottomright.png"))),
                                    ),
                                  ],
                                ),
                              ],
