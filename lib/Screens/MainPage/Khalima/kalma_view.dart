...
class KalmaView extends StatefulWidget {
  KalmaView({this.arbicKalma, this.urduKalma, this.kalmaName});
  final String? arbicKalma;
  final String? urduKalma;
  final String? kalmaName;
